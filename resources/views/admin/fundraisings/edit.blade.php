            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.fundraisings.update', $fundraising) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="target_amount" class="block mt-1 w-full" type="number" name="target_amount" value="{{ $fundraising->target_amount }}"  autofocus autocomplete="target_amount" />
