...
class FundraisingiWithdrawalController extends Controller
{
    /**
    ...
    {
        //
        $fundraising_withdrawals = FundraisingiWithdrawal::orderByDesc('id')->get();
     ...
     */
    public function show(FundraisingiWithdrawal $fundraisingWithdrawal)
    {
        //
     ...
     */
    public function edit(FundraisingiWithdrawal $fundraisingiWithdrawal)
    {
        //
    }
     ...
     */
    public function update(UpdateFundraisingWithdrawalRequest $request, FundraisingiWithdrawal $fundraisingWithdrawal)
    {
        //
     ...
     */
    public function destroy(FundraisingiWithdrawal $fundraisingiWithdrawal)
    {
        //
    }
}
